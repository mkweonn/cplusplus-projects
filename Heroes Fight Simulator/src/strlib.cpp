/* strlib.cpp
* This program splits a strings components given a delimiter to split on and returns a vector with each components.
...
{
    std::vector<std::string> items; // vector to hold the components
